...
import { errorHandler, requireBody, validateVaultAccount } from "../../src/api/middleware"
import { SigningError, ValidationError } from "../../src/errors/errors"
...
describe("middleware", () => {
  ...
  describe("requireBody", () => {
    ...
    it("should throw ValidationError if body is missing", () => {
      ...
      expect(() => requireBody(req, mockRes, mockNext)).toThrow(ValidationError)
    })
