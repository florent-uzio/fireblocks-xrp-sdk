...
import { type ApiServiceConfig } from "../pool/types.js"
import { Logger } from "../utils/logger.js"
import { FbksXrpApiService } from "./ApiService.js"
import { errorHandler } from "./middleware.js"
import { configureDexRoutes, configureTokenRoutes } from "./routes/index.js"
...
if (fbksXrpApiServiceConfigs.apiKey === "") {
  ...
  throw new ValidationError("InvalidEnvParams", "FIREBLOCKS_API_KEY is required")
}
if (fbksXrpApiServiceConfigs.apiSecret === "") {
  logger.error("FIREBLOCKS_SECRET_KEY is not set in environment variables")
  throw new ValidationError("InvalidEnvParams", "FIREBLOCKS_SECRET_KEY is required")
}
...
if (fs.existsSync(swaggerFile)) {
  ...
  logger.warn('swagger.json not found. Run "npm run generate-swagger" to generate it.')
}
