...
describe("FbksXrpApiService", () => {
  ...
  test.each(testCases)("executes %s via the corresponding SDK method", async (txType, method) => {
    ...
    expect((mockSdkInstance as any)[method]).toHaveBeenCalledWith(minimalParams[txType])
