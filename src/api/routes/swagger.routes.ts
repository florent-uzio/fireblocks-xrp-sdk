...
router.post("/api/dex/offerCreate/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/dex/offerCancel/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/dex/crossCurrencyPayment/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/dex/credentialCreate/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/dex/credentialAccept/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/dex/credentialDelete/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['DEX']
...
router.post("/api/token/tokenTransfer/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/burnToken/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/clawback/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/freezeToken/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/trustSet/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/accountSet/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
...
router.post("/api/token/xrpTransfer/:vaultAccountId", (req: Request, res: Response) => {
  // #swagger.tags = ['Token']
